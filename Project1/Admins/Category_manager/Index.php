...
/*    //Äá»• dá»¯ liá»‡u vÃ o báº£ng
    foreach ($categories as $category){
        */?>
        <tr>
            <td>
                <a href="edit.php?id=<?php /*= $category['id'] */?>" style="margin: 10px; text-decoration: none">Edit</a>
                <?php /*= $category['id'] */?>
            </td>
            <td>
                <?php /*= $category['name'] */?>
            ...
            <td>
                <a href="delete.php?id=<?php /*= $category['id'] */?>" style="text-decoration: none">DELETE</a>
            </td>
        </tr>
        <?php
/*    }
                ...
                <div class="list-member">
                    ...
                    <div class="table-member-1">
                        <table style="width: 100%">
                            ...
                            <tr>
                                <td style="font-size: 1.5rem" align="center"><?=$category['id']?></td>
                                <td style="font-size: 1.5rem" align="center"><?= $category['name']?></td>
                                <td class="form-group" align="center" >
                                    <a href="edit.php?id=<?=$category['id']?>" class="pencil-primary">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
                                    <a href="delete.php?id=<?=$category['id']?>" class="gliphycon-remove">
