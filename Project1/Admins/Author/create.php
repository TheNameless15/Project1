        ...
        <div class="col l-9">
            <div class="menu-left">
                ...
                <form action="store.php" role="form" method="post">
                    <div class="form-group">
                        <label style="font-size: 2rem">Họ và tên</label>
                        <input name="name" required class="form-control" placeholder="" style="background-color: rgb(217, 217, 217); color: rgb(154, 156, 156);">
                    </div>

                    <div class="form-group">
                        <label style="font-size: 2rem">Quê Quán</label>
                        <input name="country" required class="form-control" placeholder="" style="background-color: rgb(217, 217, 217); color: rgb(154, 156, 156);">
                    </div>
                    <button class="btn-default" style="font-size: 1.25rem">Thêm tác giả</button>
                </form>
            </div>
        </div>
    </div>
