...
<head>
    ...
    $sqlCategoriesBooks = "SELECT books.* , categories.name as book_categories , categories.id  from books inner join categories on books.category_id = categories.id WHERE books.name LIKE '%$search%' ORDER BY price asc LIMIT $start, $recordOnePage";
            ...
            <div class="grid__column-10" style="height: 600px">
                <div class="home-filter" style="background: rgb(133,131,131)">
                    ...
                    <div class="select-input" style="background: #ffffff;">
                        <span class="select-input_label" style="color:rgb(16,13,13);">- Giá thấp đến cao</span>
