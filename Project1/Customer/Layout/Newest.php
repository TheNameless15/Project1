...
<head>
    ...
    $sqlCategoriesBooks = "SELECT books.* , categories.name as book_categories , categories.id  from books inner join categories on books.category_id = categories.id  WHERE books.name  LIKE '%$search%' ORDER BY books.id desc LIMIT $start, $recordOnePage";
        ...
        <div class="grid__row app__content">
            ...
            <div class="grid__column-10" style="height: 600px">
                <div class="home-filter">
                    ...
                    <a href="Popular.php" style="text-decoration: none" class="home-filter__btn btn">Phổ biến</a>
                    <a href="Newest.php" style="text-decoration: none" class="home-filter__btn btn btn-primary">Mới nhất</a>
                    <a href="Best_Seller.php" style="text-decoration: none" class="home-filter__btn btn">Bán chạy</a>
